...
public class AttendanceController {
    ...
    // GET /api/attendances/user/{userId}/{attendanceId}
    @GetMapping("/user/{userId}/{attendanceId}")
    public ResponseEntity<AttendanceEntity> findUserAttendance(
            @PathVariable Long userId,
            @PathVariable Long attendanceId) {

        return ResponseEntity.ok(
                attendanceService.findUserAttendance(
                        userId,
                        attendanceId
                )
        );
